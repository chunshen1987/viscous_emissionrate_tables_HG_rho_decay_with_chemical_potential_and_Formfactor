...
void HG_1to3_decay::get_bulkvis_coefficients_relaxation(double T)
...
void HG_1to3_decay::get_bulkvis_coefficients_relaxation_2(double T)
// coefficients from EOS
{
   double cs2 = EOS_ptr->get_cs2_from_temperature(T);
   double ed = EOS_ptr->get_energy_density_from_temperature(T)/hbarC;   // 1/fm^4
   double pressure = EOS_ptr->get_pressure_from_temperature(T)/hbarC;
...
double HG_1to3_decay::bulkvis_integrand_relaxation(double T, double E1, double E2, double Eq, double f0_E1, double f0_E2, double f0_E3, double bulkvis_Cbulk_in, double bulkvis_e2_in)
{
   double E3 = E1 - E2 - Eq;
   ...
   double integrand = (1. + f0_E1)*bulkvis_Cbulk_in/(E1_over_T)*(-m[0]*m[0]/(3.*T*T) + bulkvis_e2_in*E1_over_T*E1_over_T)
                      + f0_E2*bulkvis_Cbulk_in/(E2_over_T)*(-m[1]*m[1]/(3.*T*T) + bulkvis_e2_in*E2_over_T*E2_over_T)
